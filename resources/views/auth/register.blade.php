                        ...
                        <div class="row">
                            <div class="col-lg-6 p-5">
                                <div class="mx-auto mb-5">
                                    <a href="/">
                                        <img src="assets/images/logokominfo.png" alt="" height="50" />
                                        <h3 class="d-inline align-middle ml-1 text-logo">SIM RAJA</h3>
                                    </a>
                                </div>

                                <h6 class="h5 mb-0 mt-4">Create your account</h6>
                                <p class="text-muted mt-0 mb-4">Create your account through the available panel</p>
                            ...
                            <div class="col-lg-6 d-none d-md-inline-block">
                                <div class="auth-page-sidebar">
                                    ...
                                    <div class="auth-user-testimonial">
                                        <p class="font-size-24 font-weight-bold text-white mb-1">SIM RAJA</p>
                                        <p class="lead">"Sistem Informasi Manajemen Kolaborasi Kerja"</i>
                                        </p>
